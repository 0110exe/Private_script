...
local theme = {
    ...
    light_contrast = Color3.fromRGB(192, 118, 227),
    dark_contrast = Color3.fromRGB(192, 118, 227),
    outline = Color3.fromRGB(192, 118, 227),
    inline = Color3.fromRGB(192, 118, 227),
    textcolor = Color3.fromRGB(192, 118, 227),
    textborder = Color3.fromRGB(192, 118, 227),
    cursoroutline = Color3.fromRGB(192, 118, 227),
    font = 2,
    textsize = 13
}
...
do
    ...
    function library:New(info)
		local info = info or {}
        local name = info.name or info.Name or "VENUS"
        local title = info.title or info.Title or "VENUS"
